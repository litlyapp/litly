...
export default function LeafletMap({
  ...
  useEffect(() => {
    ...
    clusters.forEach((cluster) => {
      ...
      const svgIcon = L.divIcon({
        ...
        html: count > 1
          ? `<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26">
              ...
              <text x="13" y="17" text-anchor="middle" font-size="10" font-weight="bold" fill="#F2E8D5" font-family="'Libre Franklin',system-ui,sans-serif">${count}</text>
            </svg>`
      ...
      const popupContent = `
        <div style="font-family:'Libre Franklin',system-ui,sans-serif;background:#1B2A3E;border-radius:12px;padding:12px;min-width:200px;max-width:260px;">
