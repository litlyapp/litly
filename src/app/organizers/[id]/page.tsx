...
export default async function OrganizerProfilePage({
  ...
  const [upcomingResult, pastResult] = await Promise.all([
    supabase
      .from("events")
      .select(
        "id, title, description, genre, event_type, date_time, end_time, location_name, virtual_url, open_mic, rsvp_enabled, created_at, organizer:organizer_profiles(id, name, org_type)"
      )
      .eq("organizer_id", id)
      .gte("date_time", now)
