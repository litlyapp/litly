    ...
    for (const rsvp of rsvps ?? []) {
      ...
      await sendEmail({
        ...
        html: emailWrapper(`
          ...
          <p style="color:#5a4a3a;margin:0 0 20px">We're sorry — <strong>${ev.title}</strong> has been cancelled.</p>
          <table style="border-collapse:collapse;width:100%;margin-bottom:24px">
            <tr><td style="padding:8px 0;color:#7a6a5a;width:110px">Date</td><td style="padding:8px 0;color:#1B2A3E">${date}</td></tr>
