...

{
  ...
  "genre": ["array of applicable genres — pick all that apply from: poetry, fiction, nonfiction, translation, ya, craft_talk, open_mic, workshop, in_conversation, slam, other (use other only when clearly literary but nothing else fits)"],
